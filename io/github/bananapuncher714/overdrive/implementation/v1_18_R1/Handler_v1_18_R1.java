package io.github.bananapuncher714.overdrive.implementation.v1_18_R1;
...
public class Handler_v1_18_R1 implements NMSHandler {
	...
	private boolean needsUpdate() {
		...
		for ( int i = 0; i < elements.length; i++ ) {
			...
			if ( lineNumber == 1037 && element.getClassName().equalsIgnoreCase( MinecraftServer.class.getName() ) ) {
				return true;
			}
		}
		return false;
